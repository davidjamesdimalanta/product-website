...
function Service2() {
    return (
        <div className="bg-white w-full max-h-full rounded-3xl flex justify-start items-center intersect:animate-fadeIn intersect-once h-auto">
            <div className="container p-4 flex flex-col md:flex-row md:px-10 md:py-8 md:justify-center items-center h-auto">
            <img 
                src="/assets/undraw_interview_re_e5jn.svg" 
                alt="svg"
                className="h-auto w-96 md:py-10 sm:block" />
                <div className="px-4 sm:pl-8 md:pl-8 lg:pl-32 py-2">
                <h1 className="text-3xl md:text-5xl lg:text-5xl font-Poppins md:pt-3 font-semibold">
